...
execute if entity @e[type=item,distance=..1,tag=WinterPotionIngredient,nbt={Item:{id:"minecraft:azure_bluet",Count:6b}}] run scoreboard players set @s wntrPotionID 1
...
execute if score @s wntrPotionID matches 0 if entity @e[type=item,distance=..1,tag=WinterPotionIngredient,nbt={Item:{id:"minecraft:dandelion",Count:6b}}] run scoreboard players set @s wntrPotionID 3
execute if score @s wntrPotionID matches 0 if entity @e[type=item,distance=..1,tag=WinterPotionIngredient,nbt={Item:{id:"minecraft:sweet_berries",Count:6b}}] run scoreboard players set @s wntrPotionID 4
