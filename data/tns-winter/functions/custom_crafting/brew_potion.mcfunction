...
execute if score @s wntrPotionID matches 0 if entity @e[type=item,distance=..1,tag=WinterPotionIngredient,nbt={Item:{id:"minecraft:golden_apple",Count:1b}}] run scoreboard players set @s wntrPotionID 13
...
execute if score @s wntrPotionID matches 1 run data merge entity @s {Item:{id:"minecraft:potion",Count:1b,tag:{Potion:"minecraft:long_regeneration"}}}
execute if score @s wntrPotionID matches 2 run data merge entity @s {Item:{id:"minecraft:potion",Count:1b,tag:{display:{Name:'{"italic":false,"text":"Minor Potion of Fire Resistance"}'},CustomPotionEffects:[{Id:12b,Amplifier:0b,Duration:400}]}}}
...
execute if score @s wntrPotionID matches 13 run data merge entity @s {Item:{id:"minecraft:potion",Count:1b,tag:{Potion:"minecraft:strong_regeneration"}}}
