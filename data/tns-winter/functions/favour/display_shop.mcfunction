...
tellraw @s[scores={FavourShop=1}] [{"text":"All items bought here can be transferred to season 6 of TNS. To see the official register of all items to be transferred, click here: ","color":"aqua"},{"text":"https://bit.ly/33Isvdh","underlined":true,"color":"dark_purple","clickEvent":{"action":"open_url","value":"https://bit.ly/33Isvdh"}}]
