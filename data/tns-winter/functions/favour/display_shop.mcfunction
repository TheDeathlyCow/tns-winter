...
tellraw @s[scores={FavourShop=1,BeeTotemLevel=0}] [{"text":" Upgrade Bee Totem","color":"dark_green"},{"text":" - ","color":"gold"},{"text":"250 Favour","color":"gold","clickEvent":{"action":"run_command","value":"/trigger FavourShop set 1000"},"hoverEvent":{"action":"show_text","contents":{"text":"Upgrade your Bee Totem to add a Haste 2 effect when you use it"}},"underlined":false}]
tellraw @s[scores={FavourShop=1,BeeTotemLevel=1}] [{"text":" Upgrade Bee Totem","color":"dark_green"},{"text":" - ","color":"gold"},{"text":"500 Favour","color":"gold","clickEvent":{"action":"run_command","value":"/trigger FavourShop set 1000"},"hoverEvent":{"action":"show_text","contents":{"text":"Upgrade your Bee Totem to get more items in your Builder's Chest"}},"underlined":false}]
tellraw @s[scores={FavourShop=1,FishTotemLevel=0}] [{"text":" Upgrade Fish Totem","color":"dark_green"},{"text":" - ","color":"gold"},{"text":"250 Favour","color":"gold","clickEvent":{"action":"run_command","value":"/trigger FavourShop set 1001"},"hoverEvent":{"action":"show_text","contents":{"text":"Upgrade your Fish Totem to add a Luck 1 effect"}},"underlined":false}]
tellraw @s[scores={FavourShop=1,FishTotemLevel=1}] [{"text":" Upgrade Fish Totem","color":"dark_green"},{"text":" - ","color":"gold"},{"text":"500 Favour","color":"gold","clickEvent":{"action":"run_command","value":"/trigger FavourShop set 1001"},"hoverEvent":{"action":"show_text","contents":{"text":"Upgrade your Fish Totem to add a Luck 2 effect"}},"underlined":false}]
tellraw @s[scores={FavourShop=1,RabbitTotemLevel=0}] [{"text":" Upgrade Rabbit Totem","color":"dark_green"},{"text":" - ","color":"gold"},{"text":"100 Favour","color":"gold","clickEvent":{"action":"run_command","value":"/trigger FavourShop set 1002"},"hoverEvent":{"action":"show_text","contents":{"text":"Upgrade your Rabbit Totem to get a randomly enchanted book when you activate your totem"}},"underlined":false}]
...
tellraw @s[scores={FavourShop=1,FoxTotemLevel=0}] [{"text":" Upgrade Fox Totem","color":"dark_green"},{"text":" - ","color":"gold"},{"text":"100 Favour","color":"gold","clickEvent":{"action":"run_command","value":"/trigger FavourShop set 1003"},"hoverEvent":{"action":"show_text","contents":{"text":"Upgrade your Fox Totem to get a large speed boost"}},"underlined":false}]
tellraw @s[scores={FavourShop=1,FoxTotemLevel=1}] [{"text":" Upgrade Fox Totem","color":"dark_green"},{"text":" - ","color":"gold"},{"text":"750 Favour","color":"gold","clickEvent":{"action":"run_command","value":"/trigger FavourShop set 1003"},"hoverEvent":{"action":"show_text","contents":{"text":"Upgrade your Fox Totem to get immunity from hypothermia"}},"underlined":false}]
tellraw @s[scores={FavourShop=1,WolfTotemLevel=0}] [{"text":" Upgrade Wolf Totem","color":"dark_green"},{"text":" - ","color":"gold"},{"text":"100 Favour","color":"gold","clickEvent":{"action":"run_command","value":"/trigger FavourShop set 1004"},"hoverEvent":{"action":"show_text","contents":{"text":"Upgrade your Wolf Totem to be able to summon a pack of wolves when you are alone"}},"underlined":false}]
tellraw @s[scores={FavourShop=1,WolfTotemLevel=1}] [{"text":" Upgrade Wolf Totem","color":"dark_green"},{"text":" - ","color":"gold"},{"text":"750 Favour","color":"gold","clickEvent":{"action":"run_command","value":"/trigger FavourShop set 1004"},"hoverEvent":{"action":"show_text","contents":{"text":"Upgrade your Wolf Totem to upgrade the power of your summoned wolves"}},"underlined":false}]
tellraw @s[scores={FavourShop=1,RavenTotemLevel=0..1}] [{"text":" Upgrade Raven Totem","color":"dark_green"},{"text":" - ","color":"gold"},{"text":"500 Favour","color":"gold","clickEvent":{"action":"run_command","value":"/trigger FavourShop set 1005"},"hoverEvent":{"action":"show_text","contents":{"text":"Upgrade your Raven Totem to increase the number of charges you can get before needing to go back to the totem pole"}},"underlined":false}]
tellraw @s[scores={FavourShop=1,BearTotemLevel=0}] [{"text":" Upgrade Polar Bear Totem","color":"dark_green"},{"text":" - ","color":"gold"},{"text":"750 Favour","color":"gold","clickEvent":{"action":"run_command","value":"/trigger FavourShop set 1006"},"hoverEvent":{"action":"show_text","contents":{"text":"Upgrade your Polar Bear Totem to increase the regeneration and absorption power"}},"underlined":false}]
tellraw @s[scores={FavourShop=1,BearTotemLevel=1}] [{"text":" Upgrade Polar Bear Totem","color":"dark_green"},{"text":" - ","color":"gold"},{"text":"750 Favour","color":"gold","clickEvent":{"action":"run_command","value":"/trigger FavourShop set 1006"},"hoverEvent":{"action":"show_text","contents":{"text":"Upgrade your Polar Bear Totem to gain warmth when your hunger is full"}},"underlined":false}]
