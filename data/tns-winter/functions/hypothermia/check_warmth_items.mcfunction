...
execute if predicate tns-winter:warmth_items/wearing_warm_chestplate run scoreboard players add @s warmth 2
execute if predicate tns-winter:warmth_items/wearing_warm_leggings run scoreboard players add @s warmth 2
