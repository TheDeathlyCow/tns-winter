...
tellraw @s[scores={LevelOnPurchase=0,Favour=250..}] {"text":"You upgraded your Bee Totem for 250 Favour! Use /trigger AnimalTotem to get a chest full of wood and Haste 2 for 2 minutes!","color":"green"}
scoreboard players set @s[scores={LevelOnPurchase=0,Favour=250..}] BeeTotemLevel 1
