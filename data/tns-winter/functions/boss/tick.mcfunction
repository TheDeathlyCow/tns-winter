...
execute if score ticksUntilWarmthCheck winterDummy matches 5 run function tns-winter:boss/check_every_second
execute if score ticksUntilWarmthCheck winterDummy matches 15 run function tns-winter:boss/check_every_second
...
# execute if score ticksUntilWarmthCheck winterDummy matches 5 run function tns-winter:boss/station/check_every_second
# execute if score ticksUntilWarmthCheck winterDummy matches 15 run function tns-winter:boss/station/check_every_second
