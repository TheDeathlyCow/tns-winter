...
execute if score ticksUntilWarmthCheck winterDummy matches 0 as @e[type=armor_stand,tag=frostSpiritRider] at @s run function tns-winter:boss/frost_spirit/tick