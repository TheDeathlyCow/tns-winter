# as a frosty evoker rider on the ground
# at @s
# called by tns-winter:boss/frosty_evoker/tick
...
tellraw @a[distance=..25] ["",{"text":"You gained ","color":"aqua"},{"score":{"name":"@s","objective":"HeatAbsorbed"},"color":"aqua"},{"text":" warmth from the nearby Frosty Evoker!","color":"aqua"}]
